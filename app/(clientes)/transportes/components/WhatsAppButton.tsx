export default function WhatsAppButton() {
  return (
    ...
    >
      {/* Tooltip Hover */}
      <span className="absolute right-16 bg-white text-slate-800 text-sm font-bold py-2 px-4 rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
        Solicitar Cotação
      </span>

      {/* Ícone SVG original do WhatsApp */}
      <svg
        viewBox="0 0 24 24"
        width="28"
        height="28"
